...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top p-3 navbar4bg">
    ...
    <div class="container" id="test" style="margin-top: 110px;">
      <div class="card" style="width: 50rem;">
        ...
        <div class="card-body">
          <h3 class="card-title">Sayur Asem</h3>
          ...
          <p class="card-text">Sayur asem banyak dijumpai di berbagai daerah di Indonesia. Bahkan sayur ini sudah menyebar hingga mancanegara. </p><br>
          <p class="card-text">Komposisi sayur asem terdiri dari banyak sayuran, sehigga manfaatnya juga besar. Beberapa campuran sayur-sayuran dan kacang-kacangan bernilai gizi sangat tinggi.</p><br>
          ...
          <p>Nah, bagaimana mudah bukan? Yuk, buat Sayur Asem di rumah.</p>
        </div>
        <!-- bookmark button -->
