...
<head>
    ...
    <title>Kangkung bumbu tauco</title>
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top p-3 navbar4bg">
    ...
    <div class="container" id="test" style="margin-top: 110px;">
      <div class="card" style="width: 50rem;">
        ...
        <div class="card-body">
          <h3 class="card-title">Kangkung bumbu tauco</h3>
          ...
          <ul>
             ...
             <li>Merica bubuk</li>
             <li>Gula pasir</li>
             <li>12 butir telur puyuh, rebus matang, kupas</li>
          ...
          <ol>
              <li>Siapkan wajan dan panaskan minyak di atasnya.</li>
              <li>Tumis bumbu yang telah dihaluskan berbarengan dengan daun jeruk, daun salam, lengkuas, dan jahe. Aduk rata dan masak hingga harum.</li>
              <li>Masukkan tauco, aduk rata.</li>
              <li>Masukkan kangkung, aduk rata agar bumbu meresap sempurna.</li>
              <li>Bubuhi garam, merica bubuk, dan gula pasir secukupnya sesuai selera</li>
              <li>Masak hingga kangkung sedikit layu dan tambahkan telur puyuh, aduk rata.</li>
              <li>Sajikan selagi hangat.</li>
          </ol><br>
          <p>Nah, bagaimana mudah bukan? Yuk, buat Kangkung bumbu tauco di rumah.</p>
        </div>
        <!-- bookmark button -->
